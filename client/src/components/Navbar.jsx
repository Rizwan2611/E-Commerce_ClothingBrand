          ...
          <div className="flex-none md:flex-1 flex justify-start">
            <Link to="/" className="flex items-center gap-2 group" onClick={() => setMenuOpen(false)}>
              <img
                ...
                alt="VOID CULTURE"
                className={`h-20 w-auto group-hover:scale-105 transition-transform duration-300 ${isDark ? 'sepia saturate-[5] hue-rotate-[5deg] brightness-[0.9] contrast-[1.2]' : 'brightness-0 opacity-90'}`}
              />
            </Link>
          </div>
